...
public class MoviesAdapter extends RecyclerView.Adapter<MoviesAdapter.MoviesAdapterViewHolder> {
    ...
    public class MoviesAdapterViewHolder extends RecyclerView.ViewHolder implements OnClickListener {
        ...
        public MoviesAdapterViewHolder(View view) {
            super(view);
            mMoviesImageView = (ImageView) view.findViewById(R.id.iv_movie_thumb);
        ...
        public void onClick(View v) {
            ...
            Movie movieDetails = mMovieData.get(adapterPosition);
    ...
    public void onBindViewHolder(MoviesAdapterViewHolder moviesAdapterViewHolder, int position) {;
        Picasso.with(context).load(mMovieData.get(position).getPathToImage()).into(moviesAdapterViewHolder.mMoviesImageView);
    }
